...
<body onLoad="focusIt();" bgcolor="${bodyback_c}">
	<table width=500 cellpadding="0" cellspacing="0" align="center"
		...
		<tr>
			<td rowspan="2" bgcolor="${bodyback_c}" width="300">메인입니다. <input
				type="checkbox" name="checkbox" value="on">자동로그인</td>
			...
			<td colspan="3" bgcolor="${title_c}" align="center"><input
				type="submit" name="Submit" value="로그인"> <input
					...
					onclick="javascript:window.location='inputForm.jsp'"> <input
						...
						onclick="javascript:window.location='../board/list.jsp'"></td>
			</form>
		</tr>
	</table>
	...
	<table width=500 cellpadding="0" cellspacing="0" align="center"
		...
		<tr>
			...
			<td rowspan="3" bgcolor="${value_c}" align="center">님이 <br>
					방문하셨습니다
					<form method="post" action="logout.jsp">
						<input type="submit" value="로그아웃"> <input type="button"
							value="회원정보변경" onclick="javascript:window.location='modify.jsp'">
								...
								onclick="javascript:window.location='../board/list.jsp'">
									<input type="button" value="피자"
									onclick="javascript:window.location='../dominoOrder/addressChoiceForm.jsp'">
					</form></td>
		</tr>
		<tr>
